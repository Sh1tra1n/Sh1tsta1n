...
echo ""
echo "Done! Good job!"
echo "The device should now boot to iOS meow jk its normal iOS"
echo "When you unlock the device, it will respring about 30-40 seconds after"
echo "If this is your first time jailbreaking, open the new Sh1tsta1n app, then press Install"
